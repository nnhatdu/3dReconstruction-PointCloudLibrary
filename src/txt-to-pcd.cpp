...
int main(int argc, char *argv[])
{
	...
	string inputFileName = "/mnt/c/Users/matth/OneDrive - VNU-HCMUS/Sem 7/Computer Graphics/K2019-CLC-DHMT-DO AN-NHOM 3/Source code/IntrepidPCL/data/sphere.txt";
	...
	string outPCDWithNormals = outputFileNameCore + string("-n.pcd");
