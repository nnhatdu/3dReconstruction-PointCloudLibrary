...
int main(int argc, char *argv[]) {
	...
	std::string in = "/mnt/d/source/IntrepidPCL/data/chair.txt";
	std::string out = "/mnt/d/source/IntrepidPCL/data/chair.vtk";
    ...
    int grid_res = default_grid_res; // có thể thay cái này
    ...
    float radius = default_radius; // có thể thay cái này
    ...
    int min_neighbors = default_min_neighbors; // có thể thay cái này
    ...
    float search_radius = default_search_radius; // có thể thay cái này
    ...
    float leaf_size = default_leaf_size; // có thể thay cái này
    ...
    int norm_k = default_norm_k; // có thể thay cái này
    ...
    int algorithm = default_algorithm; // có thể thay cái này {1, 2, 3}
    //(argc, argv, "-algorithm", algorithm);
